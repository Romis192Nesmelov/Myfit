...
@section('content')
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h4 class="panel-title">{{ trans('content.feed_by',['date' => $data['feed']->updated_at]) }}</h4>
        </div>
        <div class="panel-body">
            <form class="form-horizontal" action="{{ url('/admin/feed') }}" method="post">
                ...
                <div class="col-md-3 col-sm-12 col-xs-12">
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <h4 class="panel-title">{{ trans('content.user_why_created_request') }}</h4>
                        </div>
                        <div class="panel-body">
                            @include('admin._user_creds_block',['user' => $data['feed']->user])
                        </div>
                    </div>
                </div>
