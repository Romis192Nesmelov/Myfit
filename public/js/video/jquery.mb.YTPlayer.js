...
(function (jQuery, ytp) {
	...
	jQuery.mbYTPlayer = {
		...
		defaults: {
			coverImage             : "/images/video-poster.jpg",
...
//		todo: This API is deprecated. Find another way to retreive the Data informations.
		...
		checkForState: function (YTPlayer) {
			...
			YTPlayer.getState = setInterval(function () {
				...
				if (YTPlayer.player.getPlayerState() == 1 && (YTPlayer.player.getDuration() < YTPlayer.player.getCurrentTime() || (stopAt > 0 && parseFloat(YTPlayer.player.getCurrentTime()) > stopAt))) {
